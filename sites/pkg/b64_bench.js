import { startWorkers } from './snippets/wasm-bindgen-rayon-61c530a5c67cc8eb/src/workerHelpers.no-bundler.js';
...
* @returns {number}
*/
export function generate_b64(iterations, b64_length) {
    const ret = wasm.generate_b64(iterations, b64_length);
    return ret >>> 0;
}
...
* @returns {number}
*/
export function bench(iterations, b64_length) {
    const ret = wasm.bench(iterations, b64_length);
    return ret >>> 0;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_static_accessor_URL_d5f3491e149fd57b = function() {
        const ret = import.meta.url;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_startWorkers_281982b70bd4da56 = function(arg0, arg1, arg2) {
